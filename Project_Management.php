            ...
            <div class="col-lg-8 col-md-12 col-sm-12 content-side content-side">
                <div class="service-details-content pl-0">
                    <div class="content-one">
                        ...
                        src="./wp-content/uploads/2023/08/imagesservice/management.jpg"                                class="attachment-printpark_1170x490 size-printpark_1170x490 wp-post-image" alt=""
                                decoding="async"></figure>
                        <div class="text-box">
                            <h2>Project Management</h2>
                            <p>Project management is the discipline of planning, executing, and controlling projects efficiently. It often involves agile methodologies for adaptability, quality assurance to ensure deliverables meet predefined standards, and risk management to identify and mitigate potential project challenges, all aimed at ensuring project succes</p>
