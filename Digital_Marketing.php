                    ...
                    <div id="nav_menu-7" class="widget widget_nav_menu">
                        ...
                        <ul id="menu-service-menu" class="menu">
                            ...
                            <li id="menu-item-1288"
                                class="menu-item menu-item-type-post_type menu-item-object-service current-menu-item menu-item-1288">
                        ...
                        <div class="banner-widget">
                            <div class="inner-box">
                                ...
                                <div class="image-box">
                                    ...
                                    <!--</div>-->
                                    <figure class="image"><img src="./wp-content/uploads/2023/08/laptop.png"
                                            alt="Awesome Image"></figure>
                                </div>
                ...
                <div class="service-details-content pl-0">
                    <div class="content-one">
                        <figure class="image-box"><img fetchpriority="high" width="770" height="490"
                                src="./wp-content/uploads/2023/08/imagesservice/marketing.jpg"
                                class="attachment-printpark_1170x490 size-printpark_1170x490 wp-post-image" alt=""
                                decoding="async"></figure>
                        <div class="text-box">
                            <h2>Digital Marketing</h2>
                            <p>Social media marketing uses platforms like Facebook, Instagram, and Twitter to build
                                brand awareness and interact with customers. Email marketing involves sending targeted
                                messages to subscribers to nurture leads and drive conversions. Pay-per-click (PPC)
                                advertising allows businesses to pay for their ads to appear at the top of search engine
                                results or on social media.
                                Digital marketing services provide businesses with the tools to reach a broader
                                audience, build brand recognition, and measure the effectiveness of their online
                                marketing efforts
